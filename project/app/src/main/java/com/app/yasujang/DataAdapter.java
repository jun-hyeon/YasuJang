...
public class DataAdapter {
    ...
    public com.app.yasujang.DataAdapter createDatabase() throws SQLException
    {
        try
        {
    ...
    public com.app.yasujang.DataAdapter open() throws SQLException
    {
        try
        {
